...
# IMPORTANTE: Substitua o texto abaixo pelo ID real de letras e números da sua planilha
...
# --- GERENCIAMENTO DE ESTADO INTERNAL (SESSION STATE) ---
...
# --- CLASSE DO MOTOR GERADOR DE PDF ---
